...
{                                                                       \
    .trainerIds = {trainer1, trainer2, trainer3, trainer4, trainer},    \
...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, TRAINER_THALIA_2, TRAINER_THALIA_3, TRAINER_THALIA_4, TRAINER_THALIA_5, ABANBONED_SHIP_ROOMS_1F),
